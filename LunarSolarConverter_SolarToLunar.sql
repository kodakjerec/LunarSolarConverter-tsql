...
/****** Object:  UserDefinedFunction [dbo].[LunarSolarConverter_SolarToLunar]    Script Date: 2021/1/8 下午 04:38:20 ******/
SET ANSI_NULLS ON
GO
...
--return 2020-11-25
*/
CREATE FUNCTION [dbo].[LunarSolarConverter_SolarToLunar]
(
	@fromDate date			--日期
)
RETURNS @lunar Table (isleap tinyint, lunarDay int, lunarMonth int, lunarYear int)
AS
BEGIN
