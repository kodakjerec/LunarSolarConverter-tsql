...
/****** Object:  UserDefinedFunction [dbo].[LunarSolarConverter_LunarToSolar]    Script Date: 2021/1/8 下午 04:38:38 ******/
SET ANSI_NULLS ON
GO
...
--return 2021-02-26
*/
CREATE FUNCTION [dbo].[LunarSolarConverter_LunarToSolar]
(
	@fromDate date			--日期
...
BEGIN
	...
	DECLARE	@lunarDay int = DATEPART(DAY,@fromDate)
        ...
        INSERT INTO @solar SELECT * FROM [dbo].[LunarSolarConverter_SolarFromInt](@g) --return this.SolarFromInt(this.SolarToInt(y, m, d) + offset - 1);
	RETURN
END
GO
